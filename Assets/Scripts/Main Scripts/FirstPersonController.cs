...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip[] m_FootstepSoundsDirt;    // an array of footstep sounds that will be randomly selected from.
        ...
        {
            if (Player.pause == false && Player.olhando == false)
            {
                float speed;
                GetInput(out speed);
        ...
        private void PlayFootStepAudio()
        {
            ...
            if(currentFootStep == 0) //Dirt Sounds
            {
            ...
            {
                // excluding sound at index 0
                int n = Random.Range(1, m_FootstepSoundsConcrete.Length);
            ...
            else if (currentFootStep == 3) //Metal Sounds
            {
                // excluding sound at index 0
            ...
            else if (currentFootStep == 4) //Water Sounds
            {
                // excluding sound at index 0
        ...
        {
            if(_col.CompareTag(Globals.WOOD_FLOOR_TAG))
            {
                currentFootStep = 1;
            }
            else if (_col.CompareTag(Globals.CONCRETE_FLOOR_TAG))
            {
                currentFootStep = 2;
            }
            else if (_col.CompareTag(Globals.METAL_FLOOR_TAG))
            {
                currentFootStep = 3;
            }
            else if (_col.CompareTag(Globals.WATER_FLOOR_TAG))
            {
                currentFootStep = 4;
            }
        }
        ...
        {
            if(_col.CompareTag(Globals.WOOD_FLOOR_TAG)|| _col.CompareTag(Globals.CONCRETE_FLOOR_TAG) || _col.CompareTag(Globals.METAL_FLOOR_TAG))
            {
                currentFootStep = 0;
            }
        }
